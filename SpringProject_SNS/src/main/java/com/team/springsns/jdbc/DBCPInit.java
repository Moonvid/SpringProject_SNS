package com.team.springsns.jdbc;
...
public class DBCPInit extends HttpServlet {
	...
	private void initConnectionPool() {
			...
			String jdbcUrl = "jdbc:mysql://localhost:3306/openproject?" + "&useUnicode=true&characterEncoding=utf8";
			//String jdbcDriver = "jdbc:oracle:thin:localhost:1521:orcl";
			//String jdbcDriver = "jdbc:oracle:thin:@open-oracle.cwriyvhlnvkb.ap-northeast-2.rds.amazonaws.com:1521:orcl";
			// RDS 계정 bitcamp1234 / 1234
			...
			poolConfig.setTestWhileIdle(true);poolConfig.setMinIdle(4);
